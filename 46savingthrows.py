...
print(norm_5_successes / rolls)
print(norm_10_successes / rolls)
print(norm_15_successes / rolls)
print(adv_5_successes / rolls)
print(adv_10_successes / rolls)
print(adv_15_successes / rolls)
print(dis_5_successes / rolls)
print(dis_10_successes / rolls)
print(dis_15_successes / rolls)